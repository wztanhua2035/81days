window.DAY81_DATA = (() => {
  ...
  const nights = [
    ...
    N('beast','野兽靠近','黑暗里传来低沉的喘息声。',{randomHazard:'beast'},'bad'),
    N('cold','寒夜','夜里的气温比预想更低。',{weakHealth:-1},'bad'),
    N('meteor','流星','六个人很久没有说话，只看着星星划过天空。',{none:true},'neutral'),
    N('wave','涨潮','夜里海浪突然推进了十几米。',{randomLoseItem:1},'bad'),
    N('thunder','雷雨','雷声整夜没有停。',{randomHealthDamage:.4},'bad'),
    N('crab','螃蟹','有人在营地旁抓到几只螃蟹。',{randomHealth:1},'good'),
    N('share','分享食物','有人把仅剩的一点食物分给状态最差的人。',{lowestHealth:1},'good'),
    N('argument','争吵','营火旁的争论越来越激烈。',{relationDown:1},'neutral'),
    N('theft','失窃','夜里似乎有人动过别人的背包。',{theft:true},'bad'),
    N('campfire','营火','火光让这个夜晚没有那么漫长。',{protectWeak:true},'good'),
    ...
    N('foodgift','食物分享','一个状态还不错的人主动拿出食物。',{lowestHealth:1},'good'),
    N('find','意外发现','有人在黑暗中摸到一件被潮水冲来的东西。',{randomItem:1},'good'),
    N('sick','生病','有人半夜开始发冷。',{randomHealth:-1},'bad'),
    N('rest','安稳的一夜','没有风雨，没有野兽，也没有争吵。',{nextCheckBonus:.1},'good'),
    N('dew','清晨露水','天亮前，大片叶片上凝满露水。有人收集到一点可以入口的水。',{randomHealth:1},'good'),
    N('branch','断枝坠落','半夜一声脆响，粗大的树枝砸进营地边缘。',{randomHealthDamage:.25},'bad'),
    N('stars','满天星光','云层散开，星空异常清晰。这个夜晚让人重新冷静下来。',{nextCheckBonus:.05},'good'),
    N('insects','虫群','潮湿天气引来大量虫子，几乎没人睡好。',{randomHealth:-1},'bad'),
